...
const (
	DeviceService_RequestDeviceRegistration_FullMethodName   = "/at.core.DeviceService/RequestDeviceRegistration"
	DeviceService_GetDeviceRegistrationResult_FullMethodName = "/at.core.DeviceService/GetDeviceRegistrationResult"
	DeviceService_CancelDeviceRegistration_FullMethodName    = "/at.core.DeviceService/CancelDeviceRegistration"
	DeviceService_AcceptDeviceRegistration_FullMethodName    = "/at.core.DeviceService/AcceptDeviceRegistration"
	DeviceService_RegisterDevice_FullMethodName              = "/at.core.DeviceService/RegisterDevice"
	DeviceService_GetDevices_FullMethodName                  = "/at.core.DeviceService/GetDevices"
	DeviceService_GetDevice_FullMethodName                   = "/at.core.DeviceService/GetDevice"
	DeviceService_ActivateDevice_FullMethodName              = "/at.core.DeviceService/ActivateDevice"
	DeviceService_DeactivateDevice_FullMethodName            = "/at.core.DeviceService/DeactivateDevice"
	DeviceService_UpdateDevice_FullMethodName                = "/at.core.DeviceService/UpdateDevice"
	DeviceService_DeleteDevice_FullMethodName                = "/at.core.DeviceService/DeleteDevice"
)
...
func (c *deviceServiceClient) RequestDeviceRegistration(ctx context.Context, in *RequestDeviceRegistrationRequest, opts ...grpc.CallOption) (*RequestDeviceRegistrationResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeviceService_RequestDeviceRegistration_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) GetDeviceRegistrationResult(ctx context.Context, in *GetDeviceRegistrationResultRequest, opts ...grpc.CallOption) (*GetDeviceRegistrationResultResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeviceService_GetDeviceRegistrationResult_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) CancelDeviceRegistration(ctx context.Context, in *CancelDeviceRegistrationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, DeviceService_CancelDeviceRegistration_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) AcceptDeviceRegistration(ctx context.Context, in *AcceptDeviceRegistrationRequest, opts ...grpc.CallOption) (*AcceptDeviceRegistrationResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeviceService_AcceptDeviceRegistration_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) ActivateDevice(ctx context.Context, in *ActivateDeviceRequest, opts ...grpc.CallOption) (*ActivateDeviceResponse, error) {
	out := new(ActivateDeviceResponse)
	err := c.cc.Invoke(ctx, DeviceService_ActivateDevice_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) DeactivateDevice(ctx context.Context, in *DeactivateDeviceRequest, opts ...grpc.CallOption) (*DeactivateDeviceResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeviceService_DeactivateDevice_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDeviceServiceServer) ActivateDevice(context.Context, *ActivateDeviceRequest) (*ActivateDeviceResponse, error) {
...
func _DeviceService_RequestDeviceRegistration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceService_RequestDeviceRegistration_FullMethodName,
	}
...
func _DeviceService_GetDeviceRegistrationResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceService_GetDeviceRegistrationResult_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeviceService_CancelDeviceRegistration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceService_CancelDeviceRegistration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeviceService_AcceptDeviceRegistration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceService_AcceptDeviceRegistration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeviceService_ActivateDevice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ActivateDeviceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).ActivateDevice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceService_ActivateDevice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).ActivateDevice(ctx, req.(*ActivateDeviceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DeviceService_DeactivateDevice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceService_DeactivateDevice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var DeviceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DeviceService_ActivateDevice_Handler,
		},
		{
